...
export const tests: Tests = [
    {
        ...
        scenario: async (page: Page): Promise<void> => {
            await page.evaluate(() => {
                const { OSigma, container } = dependencies;
                ...
                const osigma = new OSigma(graph, container);
            });
        },
    },
    {
    ...
    },
    {
        ...
        scenario: async (page: Page): Promise<void> => {
            await page.evaluate(() => {
                ...
                graph.addEdge("upper-left", "lower-right", {
                    size: 5,
                    color: "#F00",
                });
                graph.addEdge("upper-right", "lower-left", {
                    size: 5,
                    color: "#F00",
                });
    ...
    },
    {
        ...
        scenario: async (page: Page): Promise<void> => {
            await page.evaluate(() => {
                ...
                new osigma(graph, container, {
                    defaultNodeColor: "#7FFFD4",
                    defaultEdgeColor: "#AA4A44",
                });
            });
        },
    },
