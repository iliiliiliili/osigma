  ...
  },
  {
    ...
    scenario: async (page: Page): Promise<void> => {
      await page.evaluate(() => {
        ...
        new osigma(graph, container, { renderEdgeLabels: true, labelRenderedSizeThreshold: -Infinity });
      });
    },
  },
  {
  ...
  },
  {
    ...
    scenario: async (page: Page): Promise<void> => {
      await page.evaluate(() => {
        ...
        new osigma(graph, container, { defaultNodeColor: "#7FFFD4", defaultEdgeColor: "#AA4A44" });
      });
    },
  },
  {
  ...
  },
  {
    ...
    scenario: async (page: Page): Promise<void> => {
      await page.evaluate(() => {
        ...
        new osigma(lesMiserables, container, { nodeReducer, edgeReducer });
      });
    },
  },
  // {
  ...
  },
  {
    ...
    scenario: async (page: Page): Promise<void> => {
      await page.evaluate(() => {
        ...
        new osigma(graph, container, { renderEdgeLabels: true, labelRenderedSizeThreshold: 10 });
      });
    },
  },
];
