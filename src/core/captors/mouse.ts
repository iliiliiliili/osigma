/**
 * osigma.js Mouse Captor
 * ======================
 *
 * osigma's captor dealing with the user's mouse.
 * @module
 */
...
const MOUSE_ZOOM_DURATION = 0; //250;
...
> {
    ...
    handleUp(e: MouseEvent): void {
        ...
        setTimeout(() => {
            ...
            // See commit: https://github.com/jacomyal/osigma.js/commit/cfd9197f70319109db6b675dd7c82be493ca95a2
            // See also issue: https://github.com/jacomyal/osigma.js/issues/1290
