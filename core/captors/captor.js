...
/**
 * Convert mouse coords to osigma coords.
 *
 * @param  {event}       e   - A mouse event or touch object.
 * @param  {HTMLElement} dom - A DOM element to compute offset relatively to.
 * @return {object}
...
function getMouseCoords(e, dom) {
    var res = __assign(__assign({}, getPosition(e, dom)), { osigmaDefaultPrevented: false, preventosigmaDefault: function () {
...
/**
 * Convert mouse wheel event coords to osigma coords.
 *
...
/**
 * Convert touch coords to osigma coords.
 *
