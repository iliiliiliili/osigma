/**
 * This example shows how to use node and edges events in osigma.
 */

import Graph from "graphology";
import osigma from "osigma";
import { MouseCoords } from "osigma/types";

import data from "./data.json";

const container = document.getElementById("osigma-container") as HTMLElement;
const logsDOM = document.getElementById("osigma-logs") as HTMLElement;
