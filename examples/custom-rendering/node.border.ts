/**
 * This class copies osigma/rendering/webgl/programs/node.circle, but with a tiny
 ...
 * @module
 */
import { NodeDisplayData, RenderParams } from "osigma/types";
import { floatColor } from "osigma/utils";
import { NodeProgram } from "osigma/rendering/webgl/programs/common/node";
